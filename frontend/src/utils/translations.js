export const translations = {
  ...
  account: {
    ...
    workInGroup: 'Ich melde mich in einer Gruppe an',
    ...
    selectedGroupMembers: 'Mitglieder in dieser Gruppe',
    newGroupPreview: 'Neue Gruppe, bisher noch keine weiteren Mitglieder.',
    groupCapacityLabel: 'Mitglieder',
    usernameRequired: 'Bitte gib deinen Namen ein.',
    emailRequired: 'Bitte gib deine E-Mail-Adresse ein.',
    emailInvalid: 'Bitte gib eine gültige E-Mail-Adresse ein.',
    groupRequired: 'Bitte gib einen Gruppennamen ein.',
    userNotFound: 'Kein Konto mit dieser E-Mail-Adresse gefunden. Bitte prüfe die Adresse oder erstelle ein neues Konto.',
    ...
    noGroupsFoundCreateNew: 'Keine Gruppen gefunden. Gib einen Namen ein, um eine neue Gruppe zu erstellen.',
    emailAlreadyRegistered: 'Diese E-Mail-Adresse ist bereits registriert.',
    usernameAlreadyTaken: 'Dieser Name ist bereits vergeben.',
